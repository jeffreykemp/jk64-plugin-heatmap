...
prompt APPLICATION 573 - Demo GeoHeatmap Plugin
--
-- Application Export:
--   Application:     573
...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Demo GeoHeatmap Plugin')
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(82023335721378849)
,p_plugin_id=>wwv_flow_api.id(75424330494277385)
...
,p_last_updated_by=>'JEFF'
,p_last_upd_yyyymmddhh24miss=>'20160325184253'
);
...
,p_plug_query_no_data_found=>'No heatmap data to display'
,p_attribute_01=>'400'
,p_attribute_02=>'Y'
,p_attribute_03=>'Y'
,p_attribute_04=>'0.6'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(70147400424519545)
,p_name=>'on change'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P1_BIND'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(70147572614519546)
,p_event_id=>wwv_flow_api.id(70147400424519545)
,p_event_result=>'TRUE'
...
,p_cache_mode=>'NOCACHE'
,p_last_updated_by=>'JEFF'
,p_last_upd_yyyymmddhh24miss=>'20160319171414'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(75422254833240705)
,p_plug_name=>'GeoHeatmap Plugin Demo'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(75395504608240645)
,p_plug_display_sequence=>10
