...
prompt APPLICATION 573 - Heatmap Plugin Demo
--
-- Application Export:
--   Application:     573
--   Name:            Heatmap Plugin Demo
--   Date and Time:   23:25 Thursday March 17, 2016
--   Exported By:     JEFF
--   Flashback:       0
...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Heatmap Plugin Demo')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_573')
...
,p_last_upd_yyyymmddhh24miss=>'20160317232142'
...
'Query used is:',
'',
'<pre>select lat, lng, pop from sample_heatmap;</pre>',
'',
'Map style taken from <a href="https://snazzymaps.com/style/65/just-places">https://snazzymaps.com/style/65/just-places</a>.',
'',
'<p>',
'',
...
,p_plug_name=>'jk64Heatmap Plugin'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(75395504608240645)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_display_point=>'BODY'
,p_plug_source=>'select lat, lng, pop from sample_heatmap'
...
,p_attribute_04=>'0.6'
,p_attribute_05=>'20'
,p_attribute_06=>'[{"featureType":"road","elementType":"geometry","stylers":[{"visibility":"off"}]},{"featureType":"poi","elementType":"geometry","stylers":[{"visibility":"off"}]},{"featureType":"landscape","elementType":"geometry","stylers":[{"color":"#fffffa"}]},{"f'
||'eatureType":"water","stylers":[{"lightness":50}]},{"featureType":"road","elementType":"labels","stylers":[{"visibility":"off"}]},{"featureType":"transit","stylers":[{"visibility":"off"}]},{"featureType":"administrative","elementType":"geometry","styl'
||'ers":[{"lightness":40}]}]'
);
wwv_flow_api.create_page_plug(
